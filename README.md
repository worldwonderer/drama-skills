...
《孤身入魔》演示工程取材自成熟古装玄幻项目，包含项目设定、两集剧本和十二板分镜。
下面这条 15 秒竖屏成片是为展示本项目临时制作的宣传样片——连续长镜头，顾霖背棺赴关；
它不属于技能套件的默认产物。

https://github.com/user-attachments/assets/ae88b444-06e5-4964-856c-91e619020f12

15.000 秒 · 720×1280 · 24 fps · H.264 + AAC，含普通话台词、环境声、配乐与烧录中文字幕。

![《孤身入魔》中文项目控制台按制作产物浏览工程](docs/assets/dashboard-zh.png)
...
技能会选好项目、分配回环端口并打开浏览器。控制台按真实工程与产物链提供“全部”“项目开发”
“剧本”“资产设定”“分镜视频”“审查交付”六个视图，用于浏览和轻量编辑项目文本、只读预览
各阶段目录中的图片与视频、查看项目状态。临时文件仍可在“全部”中找到。控制台只跑在本机，
需要 macOS 或 Linux。
